...
const Users = () => {
  ...
  const fetchUsers = useCallback(async () => {
    ...
    try {
      ...
      setUsers(response.data?.data?.items || response.data.items || response.data || []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingUser) {
        ...
        await usersApi.update(editingUser.id || editingUser.guid, updateData);
      } else {
